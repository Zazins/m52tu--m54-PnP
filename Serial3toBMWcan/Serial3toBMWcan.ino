...
void setup(){
  ...
  Can1.setMBFilterProcessing( MB4, 0x20A, 0x1FFFFFFF );
...
void readCanMessage() {
  switch (CAN_inMsg.id)
  {
    ...
    break;
     case 0x20A:
      EGT1 = CAN_inMsg.buf[0] | (CAN_inMsg.buf[1]) | (CAN_inMsg.buf[2]) | (CAN_inMsg.buf[3]) | (CAN_inMsg.buf[4]) | (CAN_inMsg.buf[5]) | (CAN_inMsg.buf[6]);
      //Serial.print ("EGT1: "); Serial.println (EGT1);
    break;
